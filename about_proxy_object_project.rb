...
class Proxy
  ...
  def initialize(target_object)
    ...
    # ADD MORE CODE HERE
    @messages = []  # to record all the called messages
  end
  ...
  # object instanciated must still be able to perform their function
  # therefor on method_missing, ask object if it know to respond_to method_missing
