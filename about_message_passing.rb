...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # their own send method which has nothing to do with Object#send.
    ...
    # only later it was realized that the name send might also usefully be
    # used in other contexts, so __send__ was added (that's the same thing
    # that happened with id and object_id by the way)
