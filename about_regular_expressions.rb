...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # when you put really specific pattern to it
  end
  ...
  # Why?
    ...
    # From http://www.regular-expressions.info/repeat.html we see the example of
    # trying to match HTML tags with <.+>. Suppose you have the following:
    # <em>Hello World</em>
    # You may think that <.+> (. means anything and + means repeated)
    # would only match the <em> and the </em>, when in reality it will be very
    # greedy, and go from the first < to the last >. This means it will match
    # <em>Hello World</em> instead of what you wanted.

    # Making it lazy (<.+?>) will prevent this. By adding the ? after the +,
    # we tell it to repeat as few times as possible, so the first > it comes
    # across, is where we want to stop the matching.
